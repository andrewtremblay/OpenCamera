package com.andrewtremblayllc.opencam.renderers;
...
import com.andrewtremblayllc.opencam.shaders.FlippedShader;
...
public class CamRenderer implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        mProgram = createProgram(FlippedShader.VertexShader, FlippedShader.FragmentShader);
        if (mProgram == 0) {
            return;
        }
        ...
        try {
            ...
            Log.e(DebugHelper.TAG, "Cannot set preview texture target!");
        }
    ...
    private int loadShader(int shaderType, String source) {
        ...
        if (shader != 0) {
            ...
            if (compiled[0] == 0) {
                Log.e(DebugHelper.TAG, "Could not compile shader " + shaderType + ":");
                Log.e(DebugHelper.TAG, GLES20.glGetShaderInfoLog(shader));
    ...
    private int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (program != 0) {
            ...
            if (linkStatus[0] != GLES20.GL_TRUE) {
                Log.e(DebugHelper.TAG, "Could not link program: ");
                Log.e(DebugHelper.TAG, GLES20.glGetProgramInfoLog(program));
    ...
    private void checkGlError(String op) {
        ...
        while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
            Log.e(DebugHelper.TAG, op + ": glError " + error);
